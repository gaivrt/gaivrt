...
- [Deployment](deployment.md) — R2 content ingestion and automatic rebuild path
- [Liuyao Web Page](liuyao-web.md) — browser-native six-line divination page, local history, and AI boundary
- [R2 event rebuild contract](contracts/r2-event-rebuild.md)
